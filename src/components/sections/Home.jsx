...
export const Home = () => {
  ...
  <p className="text-lg md:text-xl leading-relaxed mb-8 max-w-3xl mx-auto text-muted">
    I'm a Full Stack Developer with <strong>3+ years of experience</strong> building end-to-end web applications using the <strong>MERN stack</strong>.
    I specialize in scalable systems with <strong>React, Next.js</strong>, and <strong>Node.js</strong>, with an eye for UI/UX through <strong>Tailwind CSS</strong> and <strong>Figma</strong>.
    <br /><br />
    Whether it's deploying secure <strong>REST APIs</strong>, integrating <strong>Stripe payments</strong>, or mentoring <strong>400+ learners</strong> in full-stack development and system design —
    I bring a unique mix of hands-on engineering, teaching acumen, and product thinking.
    <br /><br />
    From fast-paced startups to enterprise teams, I thrive on turning complex ideas into robust, intuitive digital experiences.
  </p>
